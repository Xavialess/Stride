...
typedef enum {
	...
	/* Extended navigation patterns */
	HAPTIC_PATTERN_VEER_LEFT,
	HAPTIC_PATTERN_VEER_RIGHT,
	HAPTIC_PATTERN_SHARP_LEFT,
	HAPTIC_PATTERN_SHARP_RIGHT,
	HAPTIC_PATTERN_BACKWARD,
